    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 via-pink-50 to-fuchsia-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-[rgb(var(--muted-foreground))] mt-1">Get started with DocVault</p>
        </div>
        ...
        <div className="card p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[rgb(var(--muted-foreground))]" />
                <input
                  type="text"
                  value={name}
            ...
            <div>
              ...
              <div className="relative">
                <Lock size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-[rgb(var(--muted-foreground))]" />
                <input
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[rgb(var(--card))] px-4 text-sm text-[rgb(var(--muted-foreground))]">or continue with</span>
            </div>
          </div>
        ...
        <p className="text-center mt-6 text-sm text-[rgb(var(--muted-foreground))]">
